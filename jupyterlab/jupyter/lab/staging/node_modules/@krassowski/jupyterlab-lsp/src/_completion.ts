 ...
 */
export type ShowDocumentationBox = boolean;
/**
 * Whether to enable continuous hinting (Hinterland mode).
 */
export type ContinuousHinting = boolean;
/**
 ...
 */
export type SuppressInvokeContinuousHintingInSpecificCodeFragments = string[];
/**
 ...
 */
export type SuppressInvokeViaTriggerCharacterInSpecificCodeFragments = string[];
/**
 ...
 */
export type KernelCompletionResponseTimeout = number;
/**
 * The sources from which to exclude completion from. Possible values include 'Kernel', 'LSP'.
 */
export type DisableCompletionsBySource = ('Kernel' | 'LSP')[];
/**
 ...
 */
export type WaitForKernelIfBusy = boolean;
/**
 ...
 */
export type CompleterTheme2 = CompleterTheme | CompleterTheme1;
/**
 * The identifier of a completer theme with icons which indicate the kind of completion. Set to null to disable icons. Search for 'completer themes' in the command palette for a command displaying available themes.
 */
export type CompleterTheme = string;
/**
 * The identifier of a completer theme with icons which indicate the kind of completion. Set to null to disable icons. Search for 'completer themes' in the command palette for a command displaying available themes.
 */
export type CompleterTheme1 = null;
/**
 ...
 */
export type TextToDisplayNextToCompletionLabel =
  | 'detail'
  | 'type'
  | 'source'
  | 'auto';
 ...
 */
export type CompleterLayout = 'detail-below' | 'side-by-side';
/**
