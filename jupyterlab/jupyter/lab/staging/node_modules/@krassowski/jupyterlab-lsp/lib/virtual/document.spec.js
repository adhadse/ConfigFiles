...
describe('VirtualDocument', () => {
    ...
    describe('#dispose', () => {
        it('disposes, but does not break methods which can be called from async callbacks', () => {
            ...
            expect(console.warn.mock.calls[0][0]).to.equal('Cannot append code block: document disposed');
        });
    });
    describe('#extract_foreign_code', () => {
        it('joins non-standalone fragments together', () => {
            let { cell_code_kept, foreign_document_map } = document.extract_foreign_code({ value: R_LINE_MAGICS, ce_editor: null }, {
                line: 0,
                column: 0
            });
    ...
    let init_document_with_Python_and_R = () => {
        let ce_editor_for_cell_1 = {};
        let ce_editor_for_cell_2 = {};
        let ce_editor_for_cell_3 = {};
        let ce_editor_for_cell_4 = {};
        // first block
        document.append_code_block({
