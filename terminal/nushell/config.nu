...
#  }
  ...
  buffer_editor: "/usr/bin/hx" # command that will be used to edit the current line buffer with ctrl+o, if unset fallback to $env.EDITOR and $env.VISUAL
  ...
  keybindings: [
    ...
    # {
    #   modifier: control                    # Ctrl+Q is null instead of history-menu
    #   keycode: char_q
    #   mode: [emacs, vi_normal, vi_insert]
    #   event: null 
    # }
    {
      modifier: control                    # Ctrl+R is for reverse search
      keycode: char_r
      mode: [emacs, vi_normal, vi_insert]
      event: null
    }
    ...
    {
      modifier: control                    # Ctrl+A is null instead of move-to-start
      keycode: char_a
      mode: [emacs, vi_normal, vi_insert]
      event: null 
    }
