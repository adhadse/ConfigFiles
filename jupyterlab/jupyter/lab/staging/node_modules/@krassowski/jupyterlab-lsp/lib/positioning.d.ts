...
export declare function is_equal(self: IPosition, other: IPosition): boolean;
...
export declare function position_at_offset(offset: number, lines: string[]): CodeEditor.IPosition;
export declare function offset_at_position(position: CodeEditor.IPosition, lines: string[], lines_include_breaks?: boolean): number;
