 ...
 */
export declare type LogAllLSPCommunicationWithTheLSPServers = boolean;
/**
 ...
 */
export declare type AskServersToSendTraceNotifications = 'off' | 'messages' | 'verbose' | null;
/**
