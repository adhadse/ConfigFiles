...
export declare type ClientCapabilities = Omit<lsp.ClientCapabilities, 'textDocument'> & {
...
export declare type ExtendedCompletionTriggerKind = CompletionTriggerKind | AdditionalCompletionTriggerKinds;
export declare type CompletionItemKindStrings = keyof typeof CompletionItemKind;
/**
...
export declare type RecommendedLanguageIdentifier = keyof typeof Languages;
/**
 ...
 */
export declare type LanguageIdentifier = RecommendedLanguageIdentifier | string;
