 ...
 */
export declare type ThresholdOfForeignCodeCoverageForChangingTheModeInAnEditor = number;
/**
 * Disable this feature. Requires reloading JupyterLab to apply changes.
 */
export declare type Disable = boolean;
/**
 * LSP code syntax highlighting settings.
 */
export interface CodeSyntax {
    foreignCodeThreshold?: ThresholdOfForeignCodeCoverageForChangingTheModeInAnEditor;
    disable?: Disable;
    [k: string]: any;
}
