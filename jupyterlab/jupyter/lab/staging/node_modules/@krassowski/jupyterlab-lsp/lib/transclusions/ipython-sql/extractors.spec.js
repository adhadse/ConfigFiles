...
import { extract_code, get_the_only_virtual, wrap_in_python_lines } from '../../extractors/testutils';
...
describe('IPython SQL extractors', () => {
    ...
    describe('%sql line magic', () => {
        ...
        it('leaves out the connection specification', () => {
            let code = wrap_in_python_lines('%sql postgresql://will:longliveliz@localhost/shakes');
    ...
    describe('%%sql cell magic', () => {
        it('extracts simple commands', () => {
            ...
            let document = get_the_only_virtual(foreign_document_map);
            expect(document.language).to.equal('sql');
            expect(document.value).to.equal("select * from character\nwhere abbrev = 'ALICE'\n");
        });
        it('leaves out the connection specification', () => {
            let code = "%%sql postgresql://will:longliveliz@localhost/shakes\nselect * from character\nwhere abbrev = 'ALICE'";
...
//# sourceMappingURL=extractors.spec.js.map