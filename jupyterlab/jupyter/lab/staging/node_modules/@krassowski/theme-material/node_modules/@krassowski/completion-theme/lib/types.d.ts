...
export declare const COMPLETER_THEME_PREFIX = "lsp-completer-theme-";
...
export declare const ILSPCompletionThemeManager: Token<ILSPCompletionThemeManager>;
export {};
