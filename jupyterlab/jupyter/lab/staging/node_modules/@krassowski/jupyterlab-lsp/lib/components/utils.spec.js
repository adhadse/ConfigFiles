...
function create_dummy_document(options) {
    return new VirtualDocument(Object.assign({ language: 'python', foreign_code_extractors: {}, overrides_registry: {}, path: 'Untitled.ipynb.py', file_extension: 'py', has_lsp_supported_file: false, console: new BrowserConsole() }, options));
}
describe('getBreadcrumbs', () => {
    ...
    it('should collapse long paths', () => {
        ...
        let breadcrumbs = getBreadcrumbs(document, {
